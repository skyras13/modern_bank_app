...
const Billing = () => (
    <section id='produdct' className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
            ...
            <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
                <img src={ apple } alt="iOS App Store" className='w-[128px] h-[42px] object-container mr-5 cursor-pointer'/>
                <img src={ google } alt="Google Play Store" className='w-[128px] h-[42px] object-container cursor-pointer'/>
            </div>
        </div>
    </section>
  )
